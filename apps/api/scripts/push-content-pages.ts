...
const PAGES: { key: string; title: string; body: string }[] = [
  {
    ...
    body: [
      'BRICOLOC n’est pas un magasin avec un guichet ouvert toute la journée : **tout se réserve en ligne**, puis on vous accueille au dépôt au créneau que vous avez choisi — souvent dans les 2 h le jour même.',
      '',
      ...
      '3. Choisissez le **retrait en Click & Collect** (créneau d’enlèvement au dépôt) ou la **livraison sur chantier**.',
      '4. **Réservez et payez en ligne.** Une empreinte de caution est prise, jamais débitée si tout est rendu en ordre.',
      '5. Au créneau choisi, **présentez votre QR code** au dépôt : le matériel est déjà préparé.',
      '6. **Rapportez le matériel** nettoyé et complet au créneau de retour. La caution est libérée sous 48 h.',
      '',
  ...
  },
  {
    ...
    title: 'Click & Collect',
    body: [
      'Réservez en ligne, on prépare, vous récupérez au dépôt au créneau que vous avez choisi.',
      '',
      '- **Réservation obligatoire** : le dépôt n’a pas de guichet permanent, quelqu’un se déplace pour chaque enlèvement.',
      '- Commande validée le matin : le matériel est **souvent prêt dans les 2 heures**, le jour même.',
      '- Vous choisissez votre **créneau d’enlèvement** au moment de la commande et recevez un **e-mail de confirmation** dès que tout est prêt.',
      '- Au dépôt, **présentez le QR code** de votre réservation. Une pièce d’identité est demandée pour le retrait.',
      '- Adresse : **Gieterijstraat 49, 1601 Ruisbroek**, du lundi au samedi.',
      '',
      '## Et au retour ?',
      'Rapportez le matériel nettoyé et complet au créneau de retour. Le contrôle se fait avec vous ; la caution est libérée juste après.',
    ].join('\n'),
  },
  {
    key: 'delivery',
