...
const CONTENT: { key: string; title: string; body: string }[] = [
  {
    ...
    body: '1. Choisissez vos dates une seule fois.\n2. Ajoutez toutes vos machines et accessoires.\n3. Retrait en Click & Collect ou livraison sur chantier.\n4. Réservez et payez en ligne.\n5. Présentez votre QR code au comptoir.\n6. Rapportez le matériel, la caution est libérée.',
  },
  {
    key: 'click-collect',
    title: 'Click & Collect',
    body: 'Réservez en ligne, votre matériel est préparé et potentiellement prêt en 2 heures selon disponibilité. Présentez votre QR code au comptoir BRICOLOC.',
  },
  {
    key: 'delivery',
    title: 'Livraison',
    body: 'Livraison à domicile ou sur chantier dans la zone desservie (démo : régions de Bruxelles, Brabant wallon et flamand). Frais calculés selon la zone. Enlèvement du matériel organisé à la fin de la location.',
  },
  {
    key: 'pro',
    title: 'BRICOLOC Pro',
    body: 'Comptes professionnels : tarifs dégressifs, remises négociées, facturation mensuelle, devis rapides. Créez un compte Pro et ajoutez votre numéro de TVA.',
  },
  {
    key: 'faq',
    title: 'Questions fréquentes',
    body: 'Caution : empreinte restituée après contrôle du matériel.\nRetard : facturé au tarif journalier majoré.\nAnnulation : gratuite jusqu’à 24h avant le retrait (démo).\nDocuments : une pièce d’identité peut être demandée au retrait.',
  },
  {
    key: 'legal',
