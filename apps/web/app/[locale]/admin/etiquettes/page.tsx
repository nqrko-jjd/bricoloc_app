...
export default function AdminEtiquettes() {
  ...
  return (
    <div className="stack">
      {/* Rouleau Brother QL : étiquettes découpées 38 × 90 mm (DK-11208), paysage. */}
      <style>{`@page { size: 90mm 38mm; margin: 0; } @page ql-label { size: 90mm 38mm; margin: 0; }`}</style>
      ...
      {labels.length > 0 && (
        <div className="row no-print" style={{ gap: 10, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <span className="small muted">
            Imprimante Brother QL, papier « 38 × 90 mm » (DK-11208), orientation paysage, échelle
